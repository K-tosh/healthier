...
export interface SectionsTrendingArticle extends Struct.ComponentSchema {
  collectionName: 'components_sections_trending_articles';
  info: {
    displayName: 'Trending Article';
  };
  attributes: {
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ComponentSchemas {
      ...
      'sections.trending-article': SectionsTrendingArticle;
