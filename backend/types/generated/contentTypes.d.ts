...
export interface ApiArticleArticle extends Schema.CollectionType {
  ...
  attributes: {
    ...
    isTopStory: Attribute.Boolean;
    topStoryOrder: Attribute.Integer;
    conditions: Attribute.Relation<
      'api::article.article',
      'manyToMany',
...
export interface ApiConditionCondition extends Schema.CollectionType {
  ...
  attributes: {
    ...
    causes: Attribute.Blocks;
    symptoms: Attribute.Blocks;
    diagnosis: Attribute.Blocks;
    treatment: Attribute.Blocks;
    references: Attribute.Blocks;
...
export interface ApiHomepageHomepage extends Schema.SingleType {
  ...
  attributes: {
    ...
    seo_descreption: Attribute.String;
    heroTitle: Attribute.String;
    heroSubtitle: Attribute.String;
    cover: Attribute.Media;
    wellness_articles: Attribute.Relation<
      'api::homepage.homepage',
      'oneToMany',
      'api::wellness-article.wellness-article'
    >;
    wellnessTitle: Attribute.String;
    featuredConditionsTitle: Attribute.String;
    conditions: Attribute.Relation<
      'api::homepage.homepage',
      'oneToMany',
      'api::condition.condition'
    >;
    promoText: Attribute.Blocks;
    promoLInk: Attribute.String;
...
export interface ApiMedicationMedication extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String;
    slug: Attribute.UID;
    uses: Attribute.Blocks;
    dosage: Attribute.Blocks;
    sideEffects: Attribute.Blocks;
    interactions: Attribute.Blocks;
    precautions: Attribute.Blocks;
    manafucture: Attribute.String;
    image: Attribute.Media;
    conditions: Attribute.Relation<
      'api::medication.medication',
      'manyToMany',
...
export interface ApiSymptomSymptom extends Schema.CollectionType {
  ...
  attributes: {
    ...
    conditions: Attribute.Relation<
      ...
      'api::condition.condition'
    >;
    whenToSeeDoctor: Attribute.Blocks;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiToolTool extends Schema.CollectionType {
  ...
  info: {
    ...
    pluralName: 'tools';
    displayName: 'tools';
    description: 'Health tools, calculators and trackers';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    toolName: Attribute.String & Attribute.Required;
    description: Attribute.Text;
    slug: Attribute.UID;
    ...
    > &
      Attribute.Required;
    toolType: Attribute.Enumeration<['e.g.', 'BMI', 'Due Date', 'etc']>;
    embedCode: Attribute.Blocks;
...
export interface ApiWellnessArticleWellnessArticle
  extends Schema.CollectionType {
  collectionName: 'wellness_articles';
  info: {
    singularName: 'wellness-article';
    pluralName: 'wellness-articles';
    displayName: 'wellnessArticle';
  };
  options: {
    draftAndPublish: true;
  };
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::wellness-article.wellness-article': ApiWellnessArticleWellnessArticle;
    }
  }
}
