...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  const page = await getPageData("drugs-and-medications");
  
  if (!page) {
    return {
      title: "Drugs & Medications",
      description: "Information about medications and treatments"
    };
  }

  const { seo } = page.attributes;
  const metadata: Metadata = {
    title: seo?.metaTitle || "Drugs & Medications",
    description: seo?.metaDescription || "Information about medications and treatments",
  };

  return metadata;
}

export default async function DrugsAndMedicationsPage({ params }: Props) {
  const page = await getPageData("drugs-and-medications");
  
  // Get fallback articles from the category
  const categoryArticles = await getCategoryArticles("drugs-and-medications");
  ...
  if (!page) {
    ...
    return (
      <main>
        <PageHeader 
          heading="Drugs & Medications" 
          text="Learn about medications, proper usage, side effects, and treatment options available in Kenya."
        />
        
        {/* Show featured content when no page sections exist */}
        <FeaturedContent data={{
          heading: "Featured Medication Information",
          description: "Essential information about drugs and medications in Kenya",
          featuredArticles: {
          ...
          <div className="max-w-7xl mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600">
                Explore our collection of articles about drugs and medications
              </p>
            </div>
        ...
        <section className="py-16 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600">
                Browse articles about drugs and medications
              </p>
            </div>
