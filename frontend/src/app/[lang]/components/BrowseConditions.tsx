...
export default function BrowseConditions({ categories }: { categories: Category[] }) {
  return (
    <section className="py-16 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-gray-900 mb-4">Browse Health Conditions</h2>
          <p className="text-lg text-gray-600">Find reliable information about common health conditions and symptoms.</p>
        </div>
            ...
            >
              <div className="text-center">
                ...
                {cat.attributes.description && (
                  <p className="text-gray-600 text-sm mb-4 line-clamp-2">{cat.attributes.description}</p>
                )}
                <Link
                  href={`/conditions/${cat.attributes.slug}`}
